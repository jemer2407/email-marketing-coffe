...
page_icon = "assets/logo-cafeteria.ico"
layout="centered"
# ---------------------------------
# FIN VARIABLES ------------------
# INICIO FRONT-END
...
st.write("##")
st.write("##")
st.title("¡Únete a la familia cafetera :coffee:!")
st.write("##")

c1,c2 = st.columns(2)

with c1:
    st.image("assets/logo-cafeteria.png")
with c2:
    st.write("##")
    ...
    st.write("##")
    st.caption("© 2024 Coffe Shop. Todos los derechos reservados")
        ...
        if not nombre:
            ...
            try:
                with st.spinner("Enviando información...."):
                    ...
                    gsheet = GoogleSheet(credentials,document_name,sheet_name) # creamos el objeto de nuestro google sheets
                    range = gsheet.get_last_row_range() # obtenemos el rango donde vamos a escribir un registro
                    gsheet.write_data(range,values)
                    st.success("¡Gracias por unirte a la familia cafetera!")
